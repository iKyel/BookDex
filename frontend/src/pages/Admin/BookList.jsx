    ...
    <div className="p-4">
      <div className="max-w-md mx-auto">
        <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
              ...
              {authorName && (
                <div>
                  <div className="px-3 py-2">
                    ...
                    <p className="inline-block border border-gray-400 rounded px-3 py-1">{authorName}</p>
                  </div>
                </div>
              )}
            </div>
          ...
          <div className="mb-4">
            <label className="block text-sm font-bold mb-2" htmlFor="synopsis">
              Tóm Tắt
            </label>
            <textarea
              className="w-full border border-gray-400 rounded px-3 py-2"
          ...
          <div className="mb-4">
            <label className="block text-sm font-bold mb-2" htmlFor="publisher">
              Nhà Xuất Bản
            </label>
            <input
              type="text"
